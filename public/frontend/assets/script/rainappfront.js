$(function() {
    ...
    var nowPlaying          =   '';
    var nowTime             =   0;
    var livetvPlayList      =   "http://old.dev/playlist";
    ...
    // Get Browser Sizes
    var playerWidth         =   $('.app-tv-container').width();
    ...
    function lookForUpdate(thetime){
        ...
        .done(function( data ) {
            ...
            $.each( getVideos, function( key, value ) {
                ...
                var timeDiff    =   moment.duration(moment(now,"DD/MM/YYYY HH:mm:ss")
                                    - moment(then,"DD/MM/YYYY HH:mm:ss")).asSeconds();

                // Log
                console.log(    'Video ID :'+value.videoId
                                + ' in : '+timeDiff
                                + ' at : '+value.startSeconds
                            );
